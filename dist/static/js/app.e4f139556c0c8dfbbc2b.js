...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_footer_index__ = __webpack_require__(47);
  ...
  methods: {
    ...
    orderDetail: function orderDetail() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_0__api_data_js__["a" /* getData */])().then(function (res) {
        console.log(_this2.$route.query.cart);
        _this2.pay = _this2.$route.query.cart;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_footer__ = __webpack_require__(47);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_header_index__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_footer_index__ = __webpack_require__(47);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_footer_index_vue__ = __webpack_require__(47);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  mounted: function mounted() {
    ...
    this.userid = this.$store.state.ChatID;
    this.informationList = this.$store.state.ChatInfo;
    this.nameinput = this.$store.state.ChatName;
  ...
  methods: {
    beforeunloadHandler: function beforeunloadHandler(e) {
      this.$socket.emit("haveUserLeave", this.nameinput);
    },
    toroom: function toroom() {
      ...
      this.$store.state.ChatID = this.userid;
      this.$store.state.ChatName = this.nameinput;
      this.$store.state.isLoginSocket = !this.$store.state.isLoginSocket;
      this.$store.state.loginUser.push(this.nameinput);
      this.loginUser = this.$store.state.loginUser;
      this.$socket.emit("connection", 1);
      this.$socket.emit("login", this.nameinput);
      this.$socket.emit("getLoginUserList");

      this.islogin = !this.islogin;

      setInterval(function () {
        _this2.$socket.emit("online");
      }, 1000);
    },
    sendmsg: function sendmsg() {
      if (this.cont != "") {
        ...
        this.$store.state.ChatInfo.push(data);
        this.informationList = this.$store.state.ChatInfo;
  ...
  sockets: {
    ...
    disconnect: function disconnect() {
      ...
      this.$socket.emit("OutToastIn", this.nameinput);
    },
    //检测socket断开链接
    ...
    login: function login(data) {
      ...
      this.userid = data.id;
      this.loginUser = data.loginUserList;
    },
    ToastIn: function ToastIn(data) {
      ...
      if (this.islogin != true) {
        Object(__WEBPACK_IMPORTED_MODULE_2_mint_ui__["Toast"])({
          message: data.msg + "\u52A0\u5165\u4E86\u623F\u95F4",
          duration: 2000
        });
      }
    },
    haveUserLeave: function haveUserLeave(msg) {
      for (var i = 0; i < this.loginUser.length; i++) {
        if (this.loginUser[i] == msg) {
          this.loginUser.splice(i, 1);
        }
      }
      //  this.loginUser.push(data);
      // console.log(this.loginUser);
    ...
    getLoginUserList: function getLoginUserList(data) {
      this.loginUser = data;
    }
  },
  components: {
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(new __WEBPACK_IMPORTED_MODULE_9_vue_socket_io___default.a({
  // connection: "http://47.96.151.77:3001",    //上线环境
  connection: "http://localhost:3002", //生产环境
  // extraHeaders: {
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05c0a05e_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(271);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-05c0a05e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05c0a05e_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_419267c0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(280);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-419267c0"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_419267c0_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6bcb5894_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(299);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6bcb5894"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_index_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6bcb5894_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_79854179_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pay_vue__ = __webpack_require__(308);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-79854179"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_pay_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_79854179_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_pay_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0e50743a_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__ = __webpack_require__(312);
function injectStyle (ssrContext) {
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0e50743a_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_login_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_fec2d312_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_classify_vue__ = __webpack_require__(324);
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-fec2d312"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_fec2d312_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_classify_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
module.exports = "data:image/png;base64,"
...
//# sourceMappingURL=app.e4f139556c0c8dfbbc2b.js.map