...
function getData() {
  return __WEBPACK_IMPORTED_MODULE_0__http__["a" /* default */].axios_get('http://localhost:3000/'); //
}
function register(name, pass) {
  return __WEBPACK_IMPORTED_MODULE_0__http__["a" /* default */].axios_get('http://localhost:3000/register?name=' + name + '&&pass=' + pass); //
}
function login(name, pass) {
  return __WEBPACK_IMPORTED_MODULE_0__http__["a" /* default */].axios_get('http://localhost:3000/login?name=' + name + '&&pass=' + pass); //
}
...
//# sourceMappingURL=app.8a494363ec86c9d85298.js.map